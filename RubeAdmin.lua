if RUBE_LOADED and not _G.RUBE_DEBUG == true then
	-- error("Rube Admin is already running!",0)
	return
end

pcall(function() getgenv().RUBE_LOADED = true end)

COREGUI = game:GetService("CoreGui")
if not game:IsLoaded() then
	local notLoaded = Instance.new("Message")
	notLoaded.Parent = COREGUI
	notLoaded.Text = 'Rube Admin is loading...'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
-- Rube Admin Accent Colors
RUBE_ACCENT = Color3.fromRGB(130, 80, 255) -- Purple accent
RUBE_ACCENT2 = Color3.fromRGB(60, 140, 255) -- Blue accent
RUBE_GLOW = Color3.fromRGB(160, 120, 255) -- Soft glow
...
function addStroke(parent, color, thickness)
...
function addGradient(parent, c1, c2, rotation)
...
Holder.Size = UDim2.new(0, 260, 0, 230)
Holder.ZIndex = 10
addCorner(Holder, 8)
addStroke(Holder, Color3.fromRGB(80, 50, 160), 1.5)
table.insert(shade2,Holder)

Title.Name = "Title"
Title.Parent = Holder
Title.Active = true
Title.BackgroundColor3 = Color3.fromRGB(28, 18, 48)
Title.BorderSizePixel = 0
Title.Size = UDim2.new(1, 0, 0, 24)
Title.Font = Enum.Font.GothamBold
Title.TextSize = 14
Title.Text = "⚡ RUBE ADMIN v" .. currentVersion
addCorner(Title, 8)
addGradient(Title, Color3.fromRGB(100, 50, 200), Color3.fromRGB(40, 100, 220), 0)
...
Dark.Parent = Holder
Dark.Active = true
Dark.BackgroundColor3 = Color3.fromRGB(14, 14, 20)
Dark.BorderSizePixel = 0
Dark.Position = UDim2.new(0, 0, 0, 50)
Dark.Size = UDim2.new(1, 0, 0, 180)
Dark.ZIndex = 10
...
Cmdbar.Position = UDim2.new(0, 5, 0, 26)
Cmdbar.Size = UDim2.new(1, -10, 0, 22)
...
Cmdbar.PlaceholderColor3 = Color3.fromRGB(100, 90, 140)
addCorner(Cmdbar, 4)
addStroke(Cmdbar, Color3.fromRGB(60, 40, 120), 1)
...
CMDsF.ScrollBarImageColor3 = Color3.fromRGB(100, 60, 200)
...
Settings.BackgroundColor3 = Color3.fromRGB(14, 14, 20)
Settings.BorderSizePixel = 0
Settings.Position = UDim2.new(0, 0, 0, 230)
Settings.Size = UDim2.new(0, 260, 0, 175)
Settings.ZIndex = 10
...
addStroke(Notification, Color3.fromRGB(80, 50, 160), 1)
table.insert(shade1,Notification)

Title_2.Name = "Title"
Title_2.Parent = Notification
Title_2.BackgroundColor3 = Color3.fromRGB(28, 18, 48)
...
Title_2.ZIndex = 10
addCorner(Title_2, 8)
addGradient(Title_2, Color3.fromRGB(100, 50, 200), Color3.fromRGB(40, 100, 220), 0)
...
Tooltip.Active = true
Tooltip.BackgroundColor3 = Color3.fromRGB(18, 18, 24)
Tooltip.BackgroundTransparency = 0.05
Tooltip.BorderSizePixel = 0
Tooltip.Size = UDim2.new(0, 210, 0, 96)
Tooltip.Visible = false
Tooltip.ZIndex = 10
addCorner(Tooltip, 6)
addStroke(Tooltip, Color3.fromRGB(60, 40, 120), 1)
table.insert(shade1,Tooltip)

Title_3.Name = "Title"
Title_3.Parent = Tooltip
Title_3.BackgroundColor3 = Color3.fromRGB(28, 18, 48)
...
IntroBackground.BackgroundColor3 = Color3.fromRGB(14, 14, 20)
IntroBackground.BorderSizePixel = 0
IntroBackground.Position = UDim2.new(0, 0, 0, 50)
IntroBackground.Size = UDim2.new(1, 0, 0, 180)
...
Logo.Position = UDim2.new(0.5, -5, 0.5, -5)
Logo.Size = UDim2.new(0, 10, 0, 10)
Logo.Image = "rbxassetid://1352543873"
Logo.ImageColor3 = RUBE_ACCENT
...
Credits.Text = "⚡ RUBE ADMIN ⚡"
Credits.TextColor3 = RUBE_GLOW
Credits.ZIndex = 10
...
currentShade1 = Color3.fromRGB(14, 14, 20)
currentShade2 = Color3.fromRGB(24, 24, 34)
currentShade3 = Color3.fromRGB(50, 40, 80)
currentText1 = Color3.fromRGB(220, 220, 240)
currentText2 = Color3.fromRGB(180, 160, 220)
currentScroll = Color3.fromRGB(100, 60, 200)
...
function saves()
	if writefileExploit() then
		if pcall(function() readfile("RubeAdmin.cfg") end) then
			if readfile("RubeAdmin.cfg") ~= nil then
				local success, response = pcall(function()
					local json = HttpService:JSONDecode(readfile("RubeAdmin.cfg"))
				...
				if not success then
					...
					writefileCooldown("RubeAdmin.cfg", defaults)
					wait()
					saves()
				end
			else
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		...
		writefileCooldown("RubeAdmin.cfg", HttpService:JSONEncode(update))
	end
end
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Rube Admin Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Rube Admin help & support.'}
			...
			if cmd then
				...
				if infTimes then
					while lastBreakTime < cmdStartTime do
						...
						if not success and _G.RUBE_DEBUG then
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'RubeAdmin.cfg' or name == 'iy_fe' then
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if State == Enum.TeleportState.Started then
		if KeepInfYield and queueteleport then
			-- TODO: Replace with your own Rube Admin loader URL
			-- queueteleport("loadstring(game:HttpGet('YOUR_RUBE_ADMIN_URL'))()") 
		end
	end
end)
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		-- TODO: Replace with your own Rube Admin version endpoint
		-- local versionJson = game:HttpGet('YOUR_RUBE_ADMIN_VERSION_URL')
		-- return HttpService:JSONDecode(versionJson)
		return {Version = currentVersion} -- Disable old version check
	end)
	
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify('Update Available','Get the new version at rubeadmin.com')
		end
...
task.spawn(function()
	...
	minimizeHolder()
	if table.find({Enum.Platform.IOS, Enum.Platform.Android}, UserInputService:GetPlatform()) then notify("Unstable Device", "On mobile, Rube Admin may have issues or features that are not functioning correctly.") end
end)