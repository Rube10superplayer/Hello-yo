...
function InMyNetWork(v1168)
    -- Fixed: Proper network ownership check with safe fallback
    ...
    if success and isOwner ~= nil then
        ...
        -- Fallback: distance-based check when network ownership API unavailable
        local character = game.Players.LocalPlayer.Character
        if character and character:FindFirstChild("HumanoidRootPart") and v1168 then
