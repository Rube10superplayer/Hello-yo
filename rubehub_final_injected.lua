...
local v484 = v466:MakeTab({"Info","rbxassetid://100173004454294"})
        ...
        if _G.AutoFarm then
            pcall(function()
                ...
                if questGui.Visible then
                    ...
                    -- FIX: only abandon if title is fully loaded AND doesn't match current monster
...
v485:AddToggle({
    Name = "Farm Submerged Island (Lv 2600 - 2800 MAX)",
...
v489:AddToggle({
    Name = "Protect Boat (Auto Buy PirateBrigade)",
...
v489:AddToggle({
    Name = "Auto Kill Anchored Terrorshark",
...
v489:AddToggle({
    Name = "Auto Kill Tide Keeper (Rumbling Waters)",
...
v489:AddToggle({
    Name = "Auto Kill Haunted Shipwreck",
...
v489:AddToggle({
    Name = "Auto Kill Treasure Island",
...
v489:AddToggle({
    Name = "Auto Terror Eye / Terror Jaw",
...
v489:AddToggle({
    Name = "Auto Shark Tooth Necklace",
...
v489:AddToggle({
    Name = "Auto Fool's Gold (All Sources)",
...
v489:AddToggle({
    Name = "Auto Farm Hearts (All Enemies)",
...
v491:AddToggle({
    ...
    Description = "Kill Mobs While Traveling Islands",
    Default = false,
...
v491:AddToggle({
    ...
    Description = "Auto Get Cheap Beli Fruit",
    Default = false,
...
v491:AddToggle({
    ...
    Description = "Kill Law Raid Boss",
    Default = false,
...
v494:AddToggle({
    ...
    Description = "Fly to Accepted Quest Player",
    Value = false,
...
v494:AddToggle({
    Name = "Auto Safe Mode",
    Description = "Safe Auto Move to Sky",
    Default = false,
    Callback = function(v1130)
        _G.SafeMode = v1130
        if not v1130 then StopTween(false) end
    end
})
spawn(function()
    pcall(function()
...
v494:AddToggle({
    Name = "Delete Lava",
    Description = "Clear Lava Tr\195\161nh B\225\187\139 M\225\186\165y Th\225\186\177ng Kid L\225\187\143 D\195\172m Lava :))",
    Default = false,
...
v496:AddToggle({
    Title = "Melee",
    Description = "Auto Upgrade Melee Stats",
    Value = false,
...
v496:AddToggle({
    Title = "Defense",
    Description = "Auto Upgrade Defense Stats",
    Value = false,
...
v496:AddToggle({
    Title = "Sword",
    Description = "Auto Upgrade Sword Stats",
    Value = false,
...
v496:AddToggle({
    Title = "Gun",
    Description = "Auto Upgrade Gun Stats",
    Value = false,
...
v496:AddToggle({
    Title = "Fruis",
    Description = "Auto Upgrade Fruit Stats",
    Value = false,
...
v496:AddButton({
    Title = "Codes",
    Description = "Auto Enter All Codes",
    Callback = function()
