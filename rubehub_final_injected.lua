...
if World1 then
    local _ = v487:AddSection({"Sea 1 Quests"})
    v487:AddToggle({
        Name = "AutoSecondSea",
...
if World2 then
    local _ = v487:AddSection({"Sea 2 Quests"})
    v487:AddToggle({
...
if World3 then
    local _ = v487:AddSection({"Sea 3 Quests"})
...
v496:AddToggle({Title = "Auto Haki (Infinite Soru)", Value = false, Callback = function(v1170)
    _G.AutoHaki = v1170
end})
spawn(function()
    while task.wait(0.1) do
...
v496:AddToggle({Title = "Infinite Soru Cooldown", Value = false, Callback = function(v1173)
    InfiniteSoru = v1173
end})
spawn(function()
    while task.wait(1) do
...
PosY = 30
v496:AddToggle({Title = "Dodge No Cooldown", Value = false, Callback = function(v1178)
